    ...
    <table class="table" id="userTable">
        ...
        <tbody>
            ...
            <?php foreach ($users as $user): ?>
                ...
                $is_protected = ($username === 'Daveskhyle');
...
// Increased the page limit from 10 to 10000 to show all users at once
$pageLimit = 10000;
        ...
        try {
            ...
            switch ($_POST['action']) {
                case 'delete_user':
                    ...
                    } elseif ($targetUser['username'] === 'Daveskhyle') {
